...
public class SysDictTypeController extends BaseController {
    ...
    @GetMapping("/page")
    public Result<List<SysDictType>> page(PageQuery pageQuery, SysDictTypeQuery sysDictTypeQuery) {
        return success(sysDictTypeService.page(pageQuery, sysDictTypeQuery));
    }
    ...
    @SaCheckPermission("system:sysDictType:query")
    @GetMapping("/list")
    public Result<List<SysDictType>> list(SysDictTypeQuery sysDictTypeQuery) {
        return success(sysDictTypeService.list(sysDictTypeQuery));
    }
    ...
    @SaCheckPermission("system:sysDictType:save")
    @PostMapping("/save")
    public Result<Boolean> save(@Valid @RequestBody SysDictType sysDictType) {
        return result(sysDictTypeService.validSave(sysDictType), OperateType.SAVE);
    }
    ...
    @GetMapping("/export")
    public ResponseEntity<Resource> exportData(SysDictTypeQuery sysDictTypeQuery) {
