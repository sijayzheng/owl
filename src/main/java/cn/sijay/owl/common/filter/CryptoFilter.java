...
import cn.sijay.owl.common.annotations.ApiEncrypt;
import cn.sijay.owl.common.exceptions.BaseException;
import cn.sijay.owl.common.properties.ApiDecryptProperties;
...
public class CryptoFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
            ...
            if (StringUtils.isNotBlank(headerValue)) {
                ...
                if (!Objects.isNull(apiEncrypt)) {
                    ...
                    exceptionResolver.resolveException(
                        ...
                        new BaseException("没有访问权限，请联系管理员授权", HttpStatus.FORBIDDEN.value()));
                    return;
                }
            }
        }
        ...
        chain.doFilter(
            ObjectUtils.getIfNull(requestWrapper, request),
            ObjectUtils.getIfNull(responseWrapper, response));
