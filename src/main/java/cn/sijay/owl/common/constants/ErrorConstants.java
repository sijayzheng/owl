...
public interface ErrorConstants {
    ...
    String USER_LOGIN_ERROR = "账号不存在或密码错误";
    String USER_ACCOUNT_LOCKED = "账号已被锁定";
    String USER_ACCOUNT_DISABLE = "账号已被禁用";
    String USER_ACCOUNT_ALREADY_EXIST = "账号已存在";
    String CAPTCHA_ERROR = "验证码错误";
    String CAPCHA_GENERATE_ERROR = "验证码生成失败";
    String CAPCHA_EXPIRED = "验证码已过期";
