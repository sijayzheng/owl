package cn.sijay.owl.common.handler;
...
public class SseHandler {
    ...
    public void publishMessage(SseMessage sseMessage) {
        SseMessage broadcastMessage = new SseMessage(sseMessage.getMessage(), sseMessage.getUserIds());
        RedisUtil.publish(SSE_TOPIC, broadcastMessage, consumer -> log.info("SSE发送主题订阅消息topic:{} session keys:{} message:{}",
            SSE_TOPIC, sseMessage.getUserIds(), sseMessage.getMessage()));
    }
