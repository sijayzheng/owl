  ...
  <#if column.queryType=='BETWEEN'>
    <#if column.htmlType=='DATETIME'>
        <el-form-item label="${column.columnComment}" prop="${column.javaField}Range">
          <el-date-picker v-model="queryParams.${column.javaField}Range" clearable format="YYYY-MM-DD hh:mm:ss" placeholder="请选择${column.columnComment}" type="datetime" value-format="YYYY-MM-DD hh:mm:ss"  @change="() => handleQuery()" />
        </el-form-item>
    <#elseif column.htmlType=='DATE'>
        <el-form-item label="${column.columnComment}" prop="${column.javaField}Range">
          <el-date-picker v-model="queryParams.${column.javaField}Range" clearable placeholder="请输入${column.columnComment}" type="date" @change="() => handleQuery()" />
        </el-form-item>
    <#elseif column.htmlType=='TIME'>
        <el-form-item label="${column.columnComment}" prop="${column.javaField}Range">
          <el-time-picker v-model="queryParams.${column.javaField}Range" clearable placeholder="请输入${column.columnComment}" @change="() => handleQuery()" />
        </el-form-item>
    </#if>
  <#elseif column.queryType=='IN'>
    <#if column.htmlType=='SELECT'>
        <el-form-item label="${column.columnComment}" prop="${column.javaField}s">
          <el-select v-model="queryParams.${column.javaField}s" clearable placeholder="请选择${column.columnComment}" @change="() => handleQuery()">
            <el-option v-for="item in emptySelectArray" :key="item.value" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
    <#elseif column.htmlType=='DATETIME'>
        <el-form-item label="${column.columnComment}" prop="${column.javaField}s">
          <el-date-picker v-model="queryParams.${column.javaField}s" clearable format="YYYY-MM-DD hh:mm:ss" placeholder="请选择${column.columnComment}" type="datetime" value-format="YYYY-MM-DD hh:mm:ss"  @change="() => handleQuery()" />
        </el-form-item>
    <#elseif column.htmlType=='DATE'>
        <el-form-item label="${column.columnComment}" prop="${column.javaField}s">
          <el-date-picker v-model="queryParams.${column.javaField}s" clearable placeholder="请输入${column.columnComment}" type="date" @change="() => handleQuery()" />
        </el-form-item>
    <#elseif column.htmlType=='TIME'>
        <el-form-item label="${column.columnComment}" prop="${column.javaField}s">
          <el-time-picker v-model="queryParams.${column.javaField}s" clearable placeholder="请输入${column.columnComment}" @change="() => handleQuery()" />
        </el-form-item>
    </#if>
  <#else>
        <#if column.htmlType=='INPUT'>
        <el-form-item label="${column.columnComment}" prop="${column.javaField}">
          <el-input v-model="queryParams.${column.javaField}" clearable placeholder="请输入${column.columnComment}" @keyup.enter="handleQuery" />
        </el-form-item>
    <#elseif column.htmlType=='SELECT'>
        <el-form-item label="${column.columnComment}" prop="${column.javaField}">
          <el-select v-model="queryParams.${column.javaField}" clearable placeholder="请选择${column.columnComment}" @change="() => handleQuery()">
            <el-option v-for="item in emptySelectArray" :key="item.value" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
    <#elseif column.htmlType=='RADIO'>
        <el-form-item label="${column.columnComment}" prop="${column.javaField}">
          <el-radio-group v-model="queryParams.${column.javaField}" @change="() => handleQuery()">
            <el-radio-button v-for="item in emptySelectArray" :key="item.value" :label="item.label" :value="item.value" />
          </el-radio-group>
        </el-form-item>
    <#elseif column.htmlType=='DATETIME'>
        <el-form-item label="${column.columnComment}" prop="${column.javaField}">
          <el-date-picker v-model="queryParams.${column.javaField}" clearable format="YYYY-MM-DD hh:mm:ss" placeholder="请选择${column.columnComment}" type="datetime" value-format="YYYY-MM-DD hh:mm:ss"  @change="() => handleQuery()" />
        </el-form-item>
    <#elseif column.htmlType=='DATE'>
        <el-form-item label="${column.columnComment}" prop="${column.javaField}">
          <el-date-picker v-model="queryParams.${column.javaField}" clearable placeholder="请输入${column.columnComment}" type="date" @change="() => handleQuery()" />
        </el-form-item>
    <#elseif column.htmlType=='TIME'>
        <el-form-item label="${column.columnComment}" prop="${column.javaField}">
          <el-time-picker v-model="queryParams.${column.javaField}" clearable placeholder="请输入${column.columnComment}" @change="() => handleQuery()" />
        </el-form-item>
    </#if>
  </#if>
</#list>
...
const tableRef = ref()
const queryParams = ref<${className}PageQuery>({
  page: 1,
  size: 10,
})
const dialogVisible = ref(false)

const { data, send: listData, total, loading } = usePagination(() => ${functionName}Api.page(queryParams.value))
